...
预编译安装包见 [Releases](https://github.com/tianyiiiii111/CloakBrowser-Manager/releases)（macOS 两个 `.dmg`、Windows 便携 `.zip`）。
...
- **应用内更新（Windows）** — 便携版右上角一键检查并安装新版本，无需手动下载 zip
...
- **桌面端**：PyInstaller + pywebview（macOS `arm64` / `x86_64` `.dmg`，Windows 便携 `.zip` + 应用内更新）
...
| **macOS** | 从 [Releases](https://github.com/tianyiiiii111/CloakBrowser-Manager/releases) 下载对应架构的新 DMG，拖入「应用程序」覆盖安装。 |
